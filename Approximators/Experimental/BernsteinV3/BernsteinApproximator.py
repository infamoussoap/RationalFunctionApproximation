...
from Approximators.utils import bernstein_to_legendre_matrix, bernstein_to_chebyshev_matrix
from Approximators.Polynomials import BernsteinPolynomial, LegendrePolynomial, ChebyshevPolynomial
from Approximators.validation_checks import check_bernstein_w, check_X_in_range
from Approximators.RationalApproximator import RationalApproximator
...
class BernsteinApproximator(ArmijoSearch, RationalApproximator, ABC):
    ...
    def f(self, X, target_ys, w, grad=False):
        ...
        numerators = [coef @ evaluated_legendre for coef in self._legendre_coef]
