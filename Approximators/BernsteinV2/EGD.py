...
from ..validation_checks import check_bernstein_w, check_target_functions
...
class EGD(BernsteinApproximator, Bernstein):
    """ Rational function approximation using Legendre polynomials on the numerator and Bernstein polynomials
        ...
        Here we only restrict w to be positive, and normalization comes from making w[m//2] constant
